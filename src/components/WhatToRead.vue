...
<template>
    <div class="mx-24 py-20 gap-y-8 flex flex-col border-b">
        <div class="text-x-black text-2xl font-bold">
            What to read next
        </div>
                ...
                <div class="flex flex-col justify-center">
                    <div class="font-medium leading-5 text-sm">
                        <span><span class="text-x-darkgrey">By </span>
                            ...
                            <span class="text-neutral-600">l Aug 23, 2022</span></span>
                    </div>
                    ...
                    <p class="mt-4 text-zinc-500 max-md:max-w-full text-sm">
