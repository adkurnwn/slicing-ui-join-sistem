...
<template>
      ...
      <div
        ...
        <div
          ...
          <div
            class="text-x-verydarkgrey tracking-[-1px] font-sen text-[28px] pt-3 leading-10 font-bold group-hover:text-white">
            Business
          </div>
          <div class="text-x-mediumgrey items-start flex self-stretch group-hover:text-white">
