...
<template>
    <div class="text-center flex flex-col gap-y-4 self-center flex-grow mb-20 w-1/3 mx-auto">
        ...
        <div
            class="pr-[5px] text-x-mediumgrey tracking-[0px] font-inter pl-1 items-center justify-center flex leading-7">
            <p class="text-center">
        ...
        <div class="flex justify-center pt-4 items-end">
            <a href="#">
                <button class="bg-x-blue hover:bg-x-yellow text-center text-white font-bold text-lg py-4 px-12">
                    Join Now
                </button>
            </a>
        </div>
